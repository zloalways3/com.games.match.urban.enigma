...
public class InvokerEventDelay_UrbanEnigma : MonoBehaviour
{
	[SerializeField] private float seconds_UrbanEnigma;
	...
	public async void TriggerEvent_UrbanEnigma()
	{
		await Task.Delay(TimeSpan.FromSeconds(seconds_UrbanEnigma));
