...
public class ToggleBehaviour_UrbanEnigma : MonoBehaviour
{
    public UnityEvent<bool> on_UrbanEnigma, off_UrbanEnigma, toggle_changed_UrbanEnigma;


    public bool value_UrbanEnigma;
    ...
    public void Toggle_UrbanEnigma()
    {
        value_UrbanEnigma = !value_UrbanEnigma;
        ValueChanged_UrbanEnigma();
    ...
    public bool GetValue_UrbanEnigma()
    {
        return value_UrbanEnigma;
    ...
    public void SetValue_UrbanEnigma(bool value)
    {
        this.value_UrbanEnigma = value;
        ValueChanged_UrbanEnigma();
    ...
    private void ValueChanged_UrbanEnigma()
    {
        if (value_UrbanEnigma)
        {
            on_UrbanEnigma.Invoke(value_UrbanEnigma);
        }
        else
        {
            off_UrbanEnigma.Invoke(value_UrbanEnigma);
        }
        toggle_changed_UrbanEnigma?.Invoke(value_UrbanEnigma);
